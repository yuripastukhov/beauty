...
&НаСервере
Процедура ПланировщикОбработкаОшибок(ДополнительныеПараметры = Неопределено, Результат = Неопределено) Экспорт
КонецПроцедуры	

&НаКлиенте
Процедура ОбновитьПланировщикКлиент(ДополнительныеПараметры = Неопределено, Результат = Неопределено) Экспорт
	ОбновитьПланировщик();
КонецПроцедуры
...
Процедура ПланировщикЗаписейПередСозданием(Элемент, Начало, Конец, ЗначенияИзмерений, Текст, СтандартнаяОбработка)
	...
	ОткрытьФорму("Документ.ЗаписьНаУслугу.Форма.ФормаДокумента", Запись, ЭтотОбъект, , , , Новый ОписаниеОповещения("ОбновитьПланировщикКлиент", ЭтаФорма));
...
Процедура ПланировщикЗаписейПередНачаломРедактирования(Элемент, НовыйЭлемент, СтандартнаяОбработка)
	...
	ОткрытьФорму("Документ.ЗаписьНаУслугу.Форма.ФормаДокумента", Новый Структура("Ключ", Элемент.ВыделенныеЭлементы[0].Значение), ЭтотОбъект, , , , Новый ОписаниеОповещения("ОбновитьПланировщикКлиент", ЭтаФорма));
...
&НаКлиенте
Процедура ОбновитьЗапись(Команда) Экспорт
	ОбновитьПланировщик();
КонецПроцедуры
