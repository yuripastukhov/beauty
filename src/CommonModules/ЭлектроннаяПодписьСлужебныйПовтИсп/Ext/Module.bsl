	...
	Для Каждого Действие Из ДействияДляУстранения Цикл
		...
		ИначеЕсли Действие = "УстановитьСертификат" Тогда
			Решение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				|%2';
				|en = '- <a href=%1>Install the certificate</a> in the Personal certificate store of an operating system user automatically.
				|%2'"), Действие, Решение);
		ИначеЕсли Действие = "УстановитьСертификатВКонтейнер" Тогда
			Решение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				|%2';
				|en = '- <a href=%1>Install a certificate in the container</a> from the application.
				|%2'"), Действие, Решение);
		КонецЕсли;
