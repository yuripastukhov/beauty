...
Процедура ДиалогВыбораФайлаПоказать(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		СообщитьПользователю(НСтр("ru = 'Без расширения работы с файлами невозможно работать с файлами.';
									|en = 'To manage files, you need to install File system extension.'"), "Объект");
	КонецЕсли;
КонецПроцедуры
