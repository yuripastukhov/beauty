	...
	Если Статус = "Ошибка" Тогда
		...
		Если ПустаяСтрока(ТекстОшибки) Тогда
			ТекстОшибки = НСтр("ru = 'Не удается загрузить адресные сведения из папки.
				...
				|
				|Техническая информация:';
				|en = 'Cannot import address details from the folder.
				|Download files from 1C website http://its.1c.ru/download/fias2 (in Russian) on your computer and then import them to the application.
				|
